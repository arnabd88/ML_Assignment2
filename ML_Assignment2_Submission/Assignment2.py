	...
	for i in range(1,2):
		for j in LRateList:
			for k in MarginList:
				...
				TrainAccuracy = ((float(len(XData) - mistakeCount))/len(XData))*100
				print 'Using Learning Rate = ',j,', number of epochs = Single Pass,  Margin = ', k,  ', Initialization = random with mean 0 and sd 0.01'
			#	print '\t Learned Weight Vector    = ', Wvec
				print '\t Learned Bias             = ', Bias
				print '\t Mistakes during Learning = ', LearningMistake
				print '\t Learning Accuracy        = ', TrainAccuracy,'%\n'
...
def Run_Q3_3_3_sp_batch_noShuffle():
	...
	for i in range(3,6):
		for j in LRateList:
			...
			mistakeCount = func.TestPerceptron(XData, YData, Wvec, Bias, maxVecLen, margin)
			TrainAccuracy = ((float(len(XData) - mistakeCount))/len(XData))*100
			print 'Using Learning Rate = ',j,' number of epochs = ',i,'  Initialization = random with mean 0 and sd 0.01'
		#	print '\t Learned Weight Vector    = ', Wvec
			print '\t Learned Bias             = ', Bias
			print '\t Mistakes during Learning = ', LearningMistake
			print '\t Learning Accuracy        = ', TrainAccuracy,'%\n'
...
def Run_Q3_3_3_sp_batch_Shuffle():
	...
	for i in range(3,6):
		for j in LRateList:
			...
			mistakeCount = func.TestPerceptron(XData, YData, Wvec, Bias, maxVecLen, margin)
			TrainAccuracy = ((float(len(XData) - mistakeCount))/len(XData))*100
			print 'Using Learning Rate = ',j,' number of epochs = ',i,'  Initialization = random with mean 0 and sd 0.01, With Shuffle'
		#	print '\t Learned Weight Vector    = ', Wvec
			print '\t Learned Bias             = ', Bias
			print '\t Mistakes during Learning = ', LearningMistake
			print '\t Learning Accuracy        = ', TrainAccuracy,'%\n'
...
def Run_Q3_grad_with_noShuffle():
	...
	for i in range(3,6):
		for k in MarginList:
			...
			TrainAccuracy = ((float(len(XData) - mistakeCount))/len(XData))*100
			print 'Using Dynamic Learning rate, number of epochs = ',i,', Margin = ', k,  ', Initialization = random with mean 0 and sd 0.01, no Shuffle'
			#print '\t Learned Weight Vector    = ', Wvec
			print '\t Learned Bias             = ', Bias
			print '\t Mistakes during Learning = ', LearningMistake
			print '\t Learning Accuracy        = ', TrainAccuracy,'%\n'
